 ...
 * This file demonstrates how to integrate Unityxeno with a web frontend
 */

// For React/Vue/Angular applications
export class UnityxenoClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new UnityxenoClient(provider, contractAddress);
